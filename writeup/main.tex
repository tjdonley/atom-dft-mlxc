...
than the descriptor resolution, sets this accuracy. This is the exchange-energy accuracy on the
exact density; the self-consistent referenced functional --- which additionally requires
conditioning the low-density reference block --- and the open-shell atoms (which require the
unrestricted exact-exchange reference) are the next stage.
