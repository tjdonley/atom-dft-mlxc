...
class SwitchesFlags:
    ...
    def __init__(
        ...
        elif xc_functional in ['LDA_PZ', 'LDA_PW', 'GGA_PBE', 'SIMPLE_GGA', 'SIMPLE_SCAN', 'SIMPLE_HOLE', 'SIMPLE_HOLE_GEA']:
            pass
    ...
    def check_xc_functional_and_use_oep_consistency(use_oep: bool, xc_functional: str):
        ...
        elif xc_functional in ['None', 'LDA_PZ', 'LDA_PW', 'GGA_PBE', 'SIMPLE_GGA', 'SIMPLE_SCAN', 'SIMPLE_HOLE', 'SIMPLE_HOLE_GEA', 'SCAN', 'RSCAN', 'R2SCAN', 'HF']:
